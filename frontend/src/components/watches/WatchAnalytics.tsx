    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {analytics.total_return !== null && (
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <p
              className={`text-2xl font-bold ${
                analytics.total_return >= 0 ? 'text-green-600' : 'text-red-600'
              }`}
            >
        ...
        {analytics.annualized_return !== null && (
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <p
              className={`text-2xl font-bold ${
                analytics.annualized_return >= 0 ? 'text-green-600' : 'text-red-600'
              }`}
            >
      ...
      {hasValues && (
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <h4 className="text-sm font-medium text-gray-900 mb-4">Value Changes</h4>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p
                  className={`text-lg font-semibold ${
                    analytics.value_change_30d >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
            ...
            {analytics.value_change_90d !== null && (
              <div>
                ...
                <p
                  className={`text-lg font-semibold ${
                    analytics.value_change_90d >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
            ...
            {analytics.value_change_1y !== null && (
              <div>
                ...
                <p
                  className={`text-lg font-semibold ${
                    analytics.value_change_1y >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
      ...
      {/* Purchase Info */}
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h4 className="text-sm font-medium text-gray-900 mb-4">Purchase Information</h4>
